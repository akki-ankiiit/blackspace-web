    ...
    <div style={{ background:T.paper, color:T.ink, fontFamily:F.body, minHeight:'100vh' }}>
      ...
      <section style={{ padding:'60px 40px 40px', position:'relative' }}>
        ...
        <div style={{ position:'relative' }}>
          <SPStatusSticker T={T} F={F} top={-10} left={120} rotate={-7} variant="tape" tape={T.popA} bg={mint} icon="◉" iconBg={T.ink} label="Right now" name="Taking briefs" />
          <SPStatusSticker T={T} F={F} top={130} right={140} rotate={8} variant="torn" bg={butter} icon="✎" iconBg={T.popB} label="Team status" name="Writing pitches" />
          <SPStar size={70} color={T.popA} rotate={18} top={60} right={60} />
          ...
          <p style={{ fontFamily:F.italic, fontStyle:'italic', fontSize:22, textAlign:'center', maxWidth:640, margin:'24px auto 0', opacity:0.85 }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1.4fr 1fr', gap:40 }}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:20 }}>
            <div style={{ background:mint, border:`1px solid ${T.ink}`, borderRadius:20, padding:24 }}>
              ...
              <a href="mailto:hello@blackspace.media" style={{ fontFamily:F.display, fontSize:32, fontWeight:700, letterSpacing:'-0.02em', textDecoration:'none', color:T.ink, display:'block' }}>hello@blackspace.media</a>
      ...
      {/* What happens next */}
      <section style={{ padding:'80px 40px', background:T.ink, color:T.paper }}>
