    ...
    <div style={{ background:T.paper, color:T.ink, fontFamily:F.body, minHeight:'100vh' }}>
      ...
      <section style={{ padding:'60px 40px 40px', position:'relative' }}>
        ...
        <div style={{ position:'relative' }}>
          <SPStatusSticker T={T} F={F} top={-10} left={140} rotate={-6} variant="tape" tape={T.popA} bg={mint} icon="$" iconBg={T.ink} label="Starts at" name="₹40k" />
          <SPStatusSticker T={T} F={F} top={140} right={140} rotate={7} variant="torn" bg={butter} icon="⏱" iconBg={T.popB} label="Typical" name="6–12 weeks" />
          <SPStar size={60} color={T.popA} rotate={18} top={60} right={60} />
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1.2fr 1fr', gap:40, marginTop:60, alignItems:'start' }}>
      ...
      <section style={{ padding:'40px 40px 80px' }}>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(12,1fr)', gridAutoRows:'auto', gap:16 }}>
          {menu.map((m,i)=>(
            <article key={i} style={{
              gridColumn:`span ${m.big?12:6}`,
              background:m.bg, border:`1px solid ${T.ink}`, borderRadius:20,
              padding:m.big?40:32, position:'relative', overflow:'hidden',
              color:m.dark?T.paper:T.ink,
              display:'grid', gridTemplateColumns:m.big?'1fr 1.4fr':'1fr', gap:m.big?48:0,
            }}>
              <div>
                ...
                <h3 style={{ fontFamily:F.display, fontSize:m.big?72:44, fontWeight:700, letterSpacing:'-0.03em', lineHeight:0.95, margin:0 }}>{m.name}</h3>
              ...
              <div style={{ display:'grid', gridTemplateColumns:m.big?'1fr 1fr':'1fr', gap:m.big?24:16, marginTop:m.big?0:24 }}>
                <div>
      ...
      <section style={{ padding:'100px 40px', background:T.ink, color:T.paper }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:40 }}>
          {[
            ...
            <div key={i} style={{ padding:'28px 0', borderTop:`1px solid ${T.paper}33` }}>
      ...
      {/* CTA */}
      <section style={{ padding:'120px 40px', textAlign:'center', background:butter, borderBottom:`1px solid ${T.ink}`, position:'relative', overflow:'hidden' }}>
        <SPStar size={120} color={T.popB} rotate={15} top={40} right={80} />
        <SPStar size={80} color={T.popA} rotate={-20} bottom={60} left={80} />
